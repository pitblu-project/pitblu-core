...
- Systemd restart supervision has a rate limit. It is not a guarantee against all
  hangs, power loss, radio interference or prolonged failure. The twelve-hour soak is pending.
...
approval. The v1.0.0 four-probe suite and twelve-hour soak remain pending.
